...
const extractTechStack = (descriptionText = "") => {
	...
	console.log("TECH INPUT:", descriptionText);
	console.log("FOUND TECH:", foundTech);
...
export function extractProjects(projectsText = "") {
	...
	for (const line of lines) {
		...
		const descriptionTechs =
			extractTechStack(currentProject.description);
	...
	console.log(
		extractTechStack(
			"React 19, TypeScript, Node.js, Express, MongoDB, Gemini AI, Tailwind CSS"
		)
	);
	return deduped;
}
